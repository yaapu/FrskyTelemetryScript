...
local function drawTelemetryBar()
  ...
  libs.drawLib.drawRVehicle(750,432,32,math.floor(telemetry.homeAngle - telemetry.yaw),CUSTOM_COLOR)
end
...
--]]
      lcd.drawText(PLOT_X+PLOT_W/2,PLOT1_Y-2,status.plotSources[conf.plotSource1][1],CUSTOM_COLOR+SMLSIZE+CENTER)
      lcd.drawText(PLOT_X,PLOT1_Y,string.format("%d", val1Max),CUSTOM_COLOR+SMLSIZE)
      lcd.drawText(PLOT_X,PLOT1_Y+PLOT_H-24,string.format("%d", val1Min),CUSTOM_COLOR+SMLSIZE)
    ...
    if conf.plotSource2 > 1 then
      ...
      lcd.drawText(PLOT_X,PLOT2_Y+PLOT_H-24,string.format("%d", val2Min),CUSTOM_COLOR+SMLSIZE)
  ...
  local nextX = libs.drawLib.drawTerrainStatus(10,39)
  libs.drawLib.drawFenceStatus(nextX,39)
end
