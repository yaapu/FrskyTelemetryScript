...
function panel.draw(widget)
  ...
  --[[
  lcd.drawText((LCD_W-280)/2,18,string.format("yaw:%d",telemetry.yaw),SMLSIZE+CUSTOM_COLOR)
  lcd.drawText((LCD_W-280)/2,18+15,string.format("angle:%d",telemetry.homeAngle),SMLSIZE+CUSTOM_COLOR)

  lcd.drawText((LCD_W-280)/2,18+30,string.format("myX:%d",myX),SMLSIZE+CUSTOM_COLOR)
  lcd.drawText((LCD_W-280)/2,18+60,string.format("myY:%d",myY),SMLSIZE+CUSTOM_COLOR)

  lcd.drawText((LCD_W-280)/2,18+80,string.format("myScreenX:%d",myScreenX),SMLSIZE+CUSTOM_COLOR)
  lcd.drawText((LCD_W-280)/2,18+100,string.format("myScreenY:%d",myScreenY),SMLSIZE+CUSTOM_COLOR)

  lcd.drawText((LCD_W-280)/2,18+80,string.format("myScreenX:%d",myScreenX),SMLSIZE+CUSTOM_COLOR)
  lcd.drawText((LCD_W-280)/2,18+100,string.format("myScreenY:%d",myScreenY),SMLSIZE+CUSTOM_COLOR)

  lcd.drawText((LCD_W-280)/2,18+120,string.format("avgDistSum:%d",avgDistSum),SMLSIZE+CUSTOM_COLOR)
  --]]
