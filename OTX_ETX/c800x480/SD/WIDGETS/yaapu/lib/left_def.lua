...
function panel.draw(widget, x, y, battId)
  ...
  if status.showMinMaxValues == true then
    libs.drawLib.drawVArrow(x+4, y+16 + 4,true,false)
    libs.drawLib.drawVArrow(x+4, y+90 + 4 ,true,false)
  end
end
