...
local function drawRightBar(widget)
  ...
  lcd.drawText(320-2, yCell-3, string.upper(status.battsource).." V", SMLSIZE+CUSTOM_COLOR+RIGHT)
  lcd.setColor(CUSTOM_COLOR,WHITE)
  if status.battery[1] * 0.01 < 10 then
    lcd.drawNumber(320-2, yCell+7, status.battery[1] + 0.5, PREC2+TXT_ALIGN+MIDSIZE+CUSTOM_COLOR+RIGHT)
  else
    lcd.drawNumber(320-2, yCell+7, (status.battery[1] + 0.5)*0.1, PREC1+TXT_ALIGN+MIDSIZE+CUSTOM_COLOR+RIGHT)
  end
  --]]
  -- aggregate batt %
  local strperc = string.format("%2d", status.battery[16])
  lcd.setColor(CUSTOM_COLOR,colorLabel)
  lcd.drawText(320-4, yPERC-3, "BATT %", SMLSIZE+CUSTOM_COLOR+RIGHT)
  lcd.setColor(CUSTOM_COLOR,WHITE)
  lcd.drawText(320-4, yPERC+7, strperc, MIDSIZE+CUSTOM_COLOR+RIGHT)
  ...
  lcd.setColor(CUSTOM_COLOR,colorLabel)
  lcd.drawText(320-2, yALT-3, string.format("%s %s", altLabel, unitLabel), SMLSIZE+CUSTOM_COLOR+RIGHT)
  lcd.setColor(CUSTOM_COLOR,WHITE)
  lcd.drawText(320-2, yALT+7, string.format("%.0f",alt), MIDSIZE+CUSTOM_COLOR+RIGHT)
  ...
  lcd.setColor(CUSTOM_COLOR,colorLabel)
  lcd.drawText(320-2, ySPD-3, string.format("%s %s", speedLabel, conf.horSpeedLabel), SMLSIZE+CUSTOM_COLOR+RIGHT)
  lcd.setColor(CUSTOM_COLOR,WHITE)
  lcd.drawText(320-2, ySPD+7, string.format("%.01f",speed), MIDSIZE+CUSTOM_COLOR+RIGHT)
