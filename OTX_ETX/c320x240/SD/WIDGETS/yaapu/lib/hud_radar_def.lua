...
function panel.draw(widget)
  ...
  if bit32.band(myCode,1) == 1 then
    ...
    local newOriginX = (320-280)/2+280/2 - (zoom*myX*0.5);
    ...
    -- center vehicle
    originX = (320-280)/2+280/2 - (zoom*myX*0.5);
  end
  ...
  lcd.drawText((320-280)/2,18,string.format("zoom:%.02f",zoom),SMLSIZE+CUSTOM_COLOR)
  lcd.drawText((320-280)/2,18+15,string.format("dist:%d",telemetry.homeDist),SMLSIZE+CUSTOM_COLOR)
  --[[
