...
function layoutLib.drawNoTelemetryData(telemetryEnabled)
  ...
  if (not utils.telemetryEnabled()) then
    ...
    lcd.drawText(160, 95, "Yaapu Telemery 2.0.x dev".." ("..'77042a5'..")", SMLSIZE+CUSTOM_COLOR+CENTER)
...
function layoutLib.drawWidgetPaused()
  if conf.pauseTelemetry == true then
    ...
    lcd.drawText(160, 95, "Yaapu Telemetry Widget 2.0.x dev".." ("..'77042a5'..")", SMLSIZE+CUSTOM_COLOR+CENTER)
  end
end
