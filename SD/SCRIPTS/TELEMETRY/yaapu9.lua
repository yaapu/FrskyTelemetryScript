...
local menuItems = {
  {"voice language:", 1, "L1", 1, { "english", "italiano" } , {"en","it"} },
...
local function drawConfigMenuBars()
  ...
  lcd.drawText(0,0,"Yaapu X9 telemetry script 1.4.1",SMLSIZE+INVERS)
...
local function init()
  loadConfig()
  pushMessage(6,"Yaapu X9 telemetry script 1.4.1")
  playSound("yaapu")
end
