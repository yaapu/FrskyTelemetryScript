...
local function drawHud(myWidget,drawLib,conf,telemetry,status,battery,utils)
  ...
  lcd.setColor(CUSTOM_COLOR,utils.colors.darkyellow)
  lcd.drawFilledRectangle(372, varioY, 8, varioH, CUSTOM_COLOR)
  ...
  if status.terrainEnabled == 1 then
    ...
    lcd.drawRectangle(314, 100, 56, 12, CUSTOM_COLOR)
    lcd.drawFilledRectangle(314, 100, 56, 12, CUSTOM_COLOR+SOLID)
  end
  ...
  if status.airspeedEnabled == 1 then
    ...
    lcd.drawRectangle(100, 100, 66, 12, CUSTOM_COLOR)
    lcd.drawFilledRectangle(100, 100, 66, 12, CUSTOM_COLOR+SOLID)
    lcd.setColor(CUSTOM_COLOR,WHITE)
  ...
  if conf.enableWIND == true then
    lcd.setColor(CUSTOM_COLOR,BLACK)
    lcd.drawRectangle(100, 114, 66, 14, CUSTOM_COLOR)
    lcd.drawFilledRectangle(100, 114, 66, 14, CUSTOM_COLOR+SOLID)
    lcd.setColor(CUSTOM_COLOR,utils.colors.darkyellow)
