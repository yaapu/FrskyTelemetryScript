...
local function drawNoTelemetryData(status,telemetry,utils,telemetryEnabled)
  ...
  if (not telemetryEnabled()) then
    ...
    lcd.drawText(130, 120, "Yaapu Telemetry Widget 1.9.6 dev", SMLSIZE+CUSTOM_COLOR)
  end
end
...
local function drawLeftRightTelemetry(myWidget,conf,telemetry,status,battery,utils)
    -- ALT
