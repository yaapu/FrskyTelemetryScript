...
local function drawNoTelemetryData(status,telemetry,utils,telemetryEnabled)
  ...
  if (not telemetryEnabled()) then
    ...
    lcd.drawText(128, 120, "Yaapu Telemetry Widget 1.9.3-beta2", SMLSIZE+CUSTOM_COLOR)
    lcd.drawText(97, 135, "w. OlliW MavSDK v21rc09 support by Risto", SMLSIZE+CUSTOM_COLOR)
  end
end
