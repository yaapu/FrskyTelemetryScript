...
local function drawPane(x,drawLib,conf,telemetry,status,alarms,battery,battId,utils)--,getMaxValue,getBitmap,drawBlinkBitmap,lcdBacklightOn)
  ...
  --lcd.drawText(92, 89, "Dist("..unitLongLabel..")", SMLSIZE+RIGHT+CUSTOM_COLOR)
  --lcd.drawText(92, 154, "WPN", SMLSIZE+RIGHT+CUSTOM_COLOR)
  ...
  -- wp bearing
  drawLib.drawRArrow(13,134,11,telemetry.wpBearing*45,CUSTOM_COLOR)
  --
  if status.showMinMaxValues == true then
