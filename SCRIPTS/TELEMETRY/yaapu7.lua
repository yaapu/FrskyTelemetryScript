...
local battCurrPos = {
  ...
  y = 25,
  yA = 25,
  flags = SMLSIZE+PREC1+INVERS,
  flagsA = SMLSIZE+INVERS
}
...
local function drawRSSI()
	local rssi = getRSSI()
	lcd.drawText(rssiPos.x, rssiPos.y, "RS:", rssiPos.flags)
...
local function init()
	...
	--
	pushMessage(6,"Yaapu ".. model .." script v1.2.1")
	playSound("yaapu")
end
