...
local menuItems = {
  ...
  {"dual battery config:", "BC", 1, { "par", "ser", "other" }, { 1, 2, 3 } },
  ...
  {"center panel layout:", "CPANE", 1, { "min" }, { 2 } },
  {"right panel layout:", "RPANE", 1, { "min","heli" }, { 2, 3 } },
...
local function drawConfigMenuBars()
  ...
  lcd.drawText(0,0,"Yaapu 2.0.0-dev",SMLSIZE+INVERS)
