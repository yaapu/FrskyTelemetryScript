...
local function drawHud(drawLib,conf,telemetry,status,battery,getMaxValue)
  ...
  drawLib.drawLineWithClipping(rollX + dx - ccx,dy + 33 + ccy,r,20,DOTTED,116,116 + 62,8,maxY)
  drawLib.drawLineWithClipping(rollX + dx - cx,dy + 33 + cy,r,8,DOTTED,116,116 + 62,8,maxY)
  drawLib.drawLineWithClipping(rollX + dx + cx,dy + 33 - cy,r,8,DOTTED,116,116 + 62,8,maxY)
  drawLib.drawLineWithClipping(rollX + dx + ccx,dy + 33 - ccy,r,20,DOTTED,116,116 + 62,8,maxY)
  ...
  for i=0,16
  do
    lcd.drawLine(116 + 62 - 3, 9+i*3, 116 + 62, 9+i*3, SOLID, ERASE)
    lcd.drawLine(116 + 62 - 2, arrowY+9+i*3, 116 + 62-2, arrowY+9+i*3, SOLID, ERASE)
  end
  -------------------------------------
  ...
  -- black borders
  lcd.drawRectangle(116, 33 - 5,   17, 11, FORCE, 0)
  lcd.drawRectangle(116 + 62 -  17 - 1, 33 - 5,  17+1, 11, FORCE, 0)
  -- erase area
  lcd.drawFilledRectangle(116, 33 - 4,   17, 9, ERASE, 0)
  lcd.drawFilledRectangle(116 + 62 -  17 - 1, 33 - 4,  17+2, 9, ERASE, 0)
  -- erase tips
  lcd.drawLine(116 +   17,33 - 3,116 +   17,33 + 3, SOLID, ERASE)
  lcd.drawLine(116 +   17+1,33 - 2,116 +   17+1,33 + 2, SOLID, ERASE)
  lcd.drawLine(116 + 62 -  17 - 2,33 - 3,116 + 62 -  17 - 2,33 + 3, SOLID, ERASE)
  lcd.drawLine(116 + 62 -  17 - 3,33 - 2,116 + 62 -  17 - 3,33 + 2, SOLID, ERASE)
  -- left tip
  lcd.drawLine(116 +   17+2,33 - 2,116 +   17+2,33 + 2, SOLID, FORCE)
  lcd.drawLine(116 +   17-1,33 - 5,116 +   17+1,33 - 3, SOLID, FORCE)
  lcd.drawLine(116 +   17-1,33 + 5,116 +   17+1,33 + 3, SOLID, FORCE)
  -- right tip
  lcd.drawLine(116 + 62 -  17 - 4,33 - 2,116 + 62 -  17 - 4,33 + 2, SOLID, FORCE)
  lcd.drawLine(116 + 62 -  17 - 3,33 - 3,116 + 62 -  17 - 1,33 - 5, SOLID, FORCE)
  lcd.drawLine(116 + 62 -  17 - 3,33 + 3,116 + 62 -  17 - 1,33 + 5, SOLID, FORCE)
    -- altitude
...
local function drawView(drawLib,conf,telemetry,status,battery,battId,getMaxValue,gpsStatuses)  
  ...
  if telemetry.ekfFailsafe > 0 then
    lcd.drawText(116 + 62/2 - 31, 20, " EKF FAILSAFE ", SMLSIZE+INVERS+BLINK)
  end
  if telemetry.battFailsafe > 0 then
    lcd.drawText(116 + 62/2 - 33, 20, " BATT FAILSAFE ", SMLSIZE+INVERS+BLINK)
  end
end
